...
export default function Research() {
  const metrics = [
    ...
    { label: "Scopus", value: 90, image: r2 },
    { label: "Patent Published", value: "06", image: r3 },
    { label: "Google Scholar", value: 4867, image: r4 },
    { label: "Publons Citation", value: 2123, image: r5 },
    { label: "Scopus Citation", value: 3870, image: r6 },
    { label: "Books", value: "03", image: r7 },
  ];
